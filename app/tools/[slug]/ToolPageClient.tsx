...
const COMPONENT_MAP: Record<string, ComponentType<any>> = {
  ...
  'bmr-tdee-calculator':     SmartCalcHub,
  'discount-calculator':     SmartCalcHub,
  'tip-calculator':          SmartCalcHub,
  'compound-interest-calculator': SmartCalcHub,
  'fuel-cost-calculator':    SmartCalcHub,
  'salary-calculator':       SmartCalcHub,
  'profit-margin-calculator':SmartCalcHub,
  'roi-calculator':          SmartCalcHub,
  'timezone-converter':      SmartCalcHub,
  'password-generator':      SmartCalcHub,
  'uuid-generator':          SmartCalcHub,
  'qr-code-generator':       SmartCalcHub,
  'sha256-generator':        SmartCalcHub,
  'base64-encoder-decoder':  SmartCalcHub,
  'binary-converter':        SmartCalcHub,
  'rgb-hex-converter':       SmartCalcHub,
  'unit-converter':          SmartCalcHub,
  'roman-numeral-converter': SmartCalcHub,
  'random-picker':           SmartCalcHub,
  'statistics-calculator':   SmartCalcHub,
  'area-calculator':         SmartCalcHub,
  'ratio-calculator':        SmartCalcHub,
...
const FULLSCREEN_SLUGS = new Set([
  ...
  'bmr-tdee-calculator','discount-calculator','tip-calculator','compound-interest-calculator',
  'fuel-cost-calculator','salary-calculator','profit-margin-calculator','roi-calculator',
  'timezone-converter','password-generator','uuid-generator','qr-code-generator',
